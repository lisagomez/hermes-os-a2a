...
| **A2 · #199** | `businessos/migrations/supabase-enriquecimiento.sql` — 5 tablas + 2 vistas, con el **gate 69-B como invariante en la tabla**, no como cortesía del código. `supabase-enriquecimiento.test.sql`: 27 pruebas de comportamiento en Postgres efímero. | fusionado · **SQL sin aplicar a producción** |
