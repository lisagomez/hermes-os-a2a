...
- [Fase 7 — enjambre (swarm)](project/fase7-swarm.md) — Coordinador A2A (fan-out acotado + presupuesto + integración con verificación final del Supervisor) sobre el trío, CONSTRUIDO y mergeado a master (PR #13, 2026-07-04, 112 tests verdes); `supabase-fase7.sql` APLICADO en prod (2026-07-04, vía management API); residuales: compose up + dogfood real. Pytest habilitado en dev (`businessos/.venv`).
