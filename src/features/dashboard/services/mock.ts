  ...
  evaluaciones: [
    {
      ...
      conceptos: [
        {
          ...
          estado: 'deducible',
          razon: 'Gasto estrictamente indispensable (LISR 27-V) con CFDI',
          fuente: { ley: 'LISR', articulo: '27-V', url: null },
          banderas: [],
        ...
        },
        {
          ...
          estado: 'dudoso',
          razon: 'Equipo de cómputo se deprecia, no se deduce directo (LISR 34-VII)',
          fuente: { ley: 'LISR', articulo: '34-VII', url: null },
      ...
      fuentes: [
        { ley: 'LISR', articulo: '27-V', url: null },
        { ley: 'LISR', articulo: '34-VII', url: null },
      ],
      disclaimer:
