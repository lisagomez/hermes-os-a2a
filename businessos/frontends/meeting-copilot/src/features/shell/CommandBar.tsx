...
import { Chip, Dialog } from '@/shared/components/ui'
...
function PanelComandos({ cerrar }: { cerrar: () => void }) {
  ...
  return (
    <Dialog abierto onCerrar={cerrar} etiqueta="Buscar reuniones, herramientas y comandos" posicion="alta" data-testid="command-bar">
