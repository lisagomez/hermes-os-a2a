...
export const CATALOGO_HERRAMIENTAS: Herramienta[] = [
  ...
  { slug: 'buzon', nombre: 'Buzón', descripcion: 'Correo institucional operado por agentes con aprobación humana', categoria: 'ejecucion', icono: 'MailCheck', estado: 'beta', ruta: '/buzon' },
