...
export const CATALOGO_HERRAMIENTAS: Herramienta[] = [
  ...
  { slug: 'calendario', nombre: 'Google Calendar', descripcion: 'Próximos eventos sincronizados desde Google Calendar (mirror compartido con control-interno)', categoria: 'agendamiento', icono: 'CalendarClock', estado: 'active', ruta: '/herramientas/calendario' },
