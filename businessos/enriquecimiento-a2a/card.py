...
def build_card() -> AgentCard:
    ...
    skill = AgentSkill(
        ...
        description=(
            ...
            "CFF (fail-closed: RFC sin consultar o dictamen rancio = bloqueado) "
            "e inferencia de correo por patron de dominio (siempre veredicto "
            "'dudoso'). Cada intento queda en un ledger con su costo; cada "
            "hallazgo cita su fuente. Cuando el RFC provisto revela persona "
            "fisica (13 caracteres), el enriquecimiento de contacto queda "
            "bloqueado mientras el grafo regulatorio (LFPDPPP 2025) no lo "
            "permita; sin RFC la condicion de persona fisica no es detectable. "
