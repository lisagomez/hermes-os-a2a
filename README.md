...
- **Fases 2–3** ✅ — **grafo** regulatorio multi-país (fiscal MX/CO; contable,
  ...
  En el repo el seed va ya en **98 reglas / 61 categorías** tras sembrar
  **comercio exterior MX** (Ley Aduanera + Ley de Comercio Exterior): padrón,
  ...
  no arancelarias, prácticas desleales, regímenes e infracciones; **logística MX**
  (LCPAF + Ley de Aviación Civil): autotransporte federal de carga y carga aérea,
  que cierran las dos categorías que el Pre-Discovery esperaba y no existían; y el
  **T-MEC** (Capítulos 4, 5 y 7): reglas de origen, certificación de origen del
...
que corre en cada PR — `npm run verify:gobernanza`, 120 comprobaciones, más la regresión
